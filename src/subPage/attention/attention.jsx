  ...
  return (
    <section className='attention' id='attention'>
      ...
      <section className='at-dec-ex-4'>
        ...
        <ul>
          <li>基本的に全員参加のだるま運び・大玉を含め、1人が2種目以上に参加すること。多くの学生がだるま運び・大玉＋他の種目に参加となります。人数の割振り上、全員が2種目の競技に参加できない場合もあります。その場合は、だるま運び・大玉（全員参加）に加えて、オープン参加種目・アトラクション種目・エキシビジョン種目への参加をするようにしてください。当日チームを組む必要がある競技に欠席者が出た場合、代理を出せなければ失格になります。クラスの人数により、1人が2種目以上でることがあります。その際にはなるべく均等に割り当ててください。1人が5種目出場などはないように。招集の関係上、2種目以上出場する場合はなるべく連続した競技への参加にならないようにしてください。クラス対抗リレー参加者は色別対抗リレーに参加できません。</li>
        </ul>
      </section>
      <section className='at-dec-ex-5'>
        <NtTitle2 classNumber={'5'} titleNumber={'05'} title={'暴力行為について'}/>
        <ul>
          <li>暴力行為、またはそれに類する行為は禁止します。プレイの上ではフェアプレイを心掛け、競技終了後は NO SIDE の精神を持ちましょう。勝ちたい上でのプレイです、お互いを尊重する精神を持ってください。暴力行為またそれに類する行為があった場合は、競技中であれど強制退場になります。またそういった行為をする傾向のある学生は、接触行為のある種目に出ることを禁止します。</li>
        </ul>
      </section>
