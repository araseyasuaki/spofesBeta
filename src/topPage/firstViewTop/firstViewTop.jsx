...
//       <div>
//       {!isVideoLoaded && (
//         <img src="./img/ft-mv-img.png" alt="Placeholder" />
//       )}
//       <video
//         loop
//         autoPlay
...
//             <img className="ft-video-frame" src="./img/ft-mv-img.png" alt='スポーツフェス競技中の写真' />
//           </div>:
...
//       <img className="ft-new-challengers" src="./img/ft-new-challengers-text.png" alt='newChallengersのテキスト画像'/>
  ...
  return (
    <section className='firstViewTop'>
      <div className='ft-dec-box-1'>
        ...
        <video  className='ft-video-img' loop autoPlay muted playsInline onLoadedData={handleVideoLoaded} style={{ display: isVideoLoaded ? 'block' : 'none' }}>
          <source src="./video/2024-digest.mp4" type="video/mp4" />
        </video>
        <img className='ft-pc-fram-img' src='./img/ft-pc-frame.svg' alt='動画の装飾用のフレーム画像'/>
        <img className='ft-mv-fram-img' src='./img/ft-mv-frame.svg' alt='動画の装飾用のフレーム画像'/>
