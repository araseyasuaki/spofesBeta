  ...
  return (
    <section className='notes' id='notes'>
      ...
      <section className='nt-dec-ex-1'>
        <NtTitle1 classNumber={'1'} titleNumber={'01'} titleName={'入場'}/>
        <ul>
      ...
      <section className='nt-dec-ex-2'>
        <NtTitle1 classNumber={'2'} titleNumber={'02'} titleName={'服装・シューズ'}/>
        <ul>
      ...
      <section className='nt-dec-ex-3'>
        <NtTitle1 classNumber={'3'} titleNumber={'03'} titleName={'運動器具の持ち込み'}/>
        <ul>
      ...
      <section className='nt-dec-ex-4'>
        <NtTitle1 classNumber={'4'} titleNumber={'04'} titleName={'食事・飲料'}/>
        <ul>
      ...
      <section className='nt-dec-ex-5'>
        <NtTitle1 classNumber={'5'} titleNumber={'05'} titleName={'応援'}/>
        <ul>
          <li>応援に必要なツールとして、メガホン、各色4本の応援大旗を提供します。（大会終了後返却）</li>
        </ul>
      </section>
      <section className='nt-dec-ex-6'>
        <NtTitle1 classNumber={'6'} titleNumber={'06'} titleName={'貴重品'}/>
        <ul>
          <li>貴重品は、原則持ち込まないでください。各自の持ち物は、各自で管理して下さい。</li>
        </ul>
      </section>
      <section className='nt-dec-ex-7'>
        <NtTitle1 classNumber={'7'} titleNumber={'07'} titleName={'タバコ・ゴミ'}/>
        <ul>
      ...
      <section className='nt-dec-ex-8'>
        <NtTitle1 classNumber={'8'} titleNumber={'08'} titleName={'けが・体調不良'}/>
        <ul>
      ...
      <section className='nt-dec-ex-9'>
        <NtTitle1 classNumber={'9'} titleNumber={'09'} titleName={'立入禁止区域'}/>
        <ul>
      ...
      <section className='nt-dec-ex-10'>
        <NtTitle1 classNumber={'10'} titleNumber={'10'} titleName={'終了後の退場'}/>
        <ul>
      ...
      <section className='nt-dec-ex-11'>
        <NtTitle1 classNumber={'11'} titleNumber={'11'} titleName={'SNS等での情報の取り扱い'}/>
        <ul>
